...
def predict_and_plot_series(model, df_daily, pollutant, test_loader, scaler, model_name="LSTM"):
    """
    ...
    plt.title(f"{pollutant} Concentration Forecast vs Reality ({model_name})", fontsize=14, fontweight="bold")
...
def main_execution() -> None:
    ...
    try:
        parquet_path = r"C:\Users\Tiago\IdeaProjects\AirTS_Forecast\Pollution Data Analysis\outputs\consolidated_pollutants.parquet"
