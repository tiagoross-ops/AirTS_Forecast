...
from environmental_data_etl_extraction import era5_land_importing_by_date
from environmental_data_etl_transform import environmental_data_conversion_era5_to_3d, process_grib_to_3d_dict
...
if __name__ == '__main__':
    ...
    single_dir = r"C:\Users\Tiago\IdeaProjects\AirTS_Forecast\EnvironmentalDataAnalysis\stored_monthly_data\2025_11_01-30"

    #single_data_dict = environmental_data_conversion_era5_to_3d(single_dir, verbose=True)
    #store_era5_3d_to_hdf5(11, 2025, single_data_dict, target_output_dir, verbose=True)